...
* ------------------------------------------------------------------------------
*/
package decoderd_pkg;

  import alu_opcodes_pkg::*;
  import csr_pkg::*;

  // opcodes
  localparam LOAD_OPCODE     = 7'b00_00011;
  localparam MISC_MEM_OPCODE = 7'b00_01111;
  localparam OP_IMM_OPCODE   = 7'b00_10011;
  localparam AUIPC_OPCODE    = 7'b00_10111;
  localparam STORE_OPCODE    = 7'b01_00011;
  localparam OP_OPCODE       = 7'b01_10011;
  localparam LUI_OPCODE      = 7'b01_10111;
  localparam BRANCH_OPCODE   = 7'b11_00011;
  localparam JALR_OPCODE     = 7'b11_00111;
  localparam JAL_OPCODE      = 7'b11_01111;
  localparam SYSTEM_OPCODE   = 7'b11_10011;
  localparam FENCE_OPCODE    = 7'b00_01111;
  localparam ECALL_OPCODE    = 7'b11_10011;
